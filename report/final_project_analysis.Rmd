...
edu_mod1 <- regsubsets(pounds_per_hour_worked ~ ., 
                            data = base_2_no_region,
                            method = "forward")

regsubsets_forward <- summary(edu_mod1)
regsubsets_forward
```

In this model, `year` comes out as most significant predictor, followed by the 
`jobs` (no. employed) and `education_score` as the least influential predictor.
