...
Fortunately many of the Excel worksheets were identically formatted, so a lot of 
repeated data cleaning was possible by writing functions. 
...
produce a sophisticated, preditive model and instead a linear model showed that
...
approximately 89% of variance in both train and test data.
